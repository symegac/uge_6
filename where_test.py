...
_, password = open("secret.txt", 'r', encoding="utf-8").readline().split(',')

def main() -> None:
    db = Database("root", password, "northwind")
    ...
    # === [(5, 'Mr.', 'Steven', 'Buchanan', 'Sales Manager', datetime.datetime(1955, 3, 4, 0, 0), 'UK'), (4, 'Mrs.', 'Margaret', 'Peacock', 'Sales Representative', datetime.datetime(1937, 9, 19, 0, 0), 'USA')]
